(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e=`modulepreload`,t=function(e){return`/front_6th_chapter1-1/`+e},n={},r=function(r,i,a){let o=Promise.resolve();if(i&&i.length>0){let r=document.getElementsByTagName(`link`),s=document.querySelector(`meta[property=csp-nonce]`),c=s?.nonce||s?.getAttribute(`nonce`);function l(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}o=l(i.map(i=>{if(i=t(i,a),i in n)return;n[i]=!0;let o=i.endsWith(`.css`),s=o?`[rel="stylesheet"]`:``,l=!!a;if(l)for(let e=r.length-1;e>=0;e--){let t=r[e];if(t.href===i&&(!o||t.rel===`stylesheet`))return}else if(document.querySelector(`link[href="${i}"]${s}`))return;let u=document.createElement(`link`);if(u.rel=o?`stylesheet`:e,o||(u.as=`script`),u.crossOrigin=``,u.href=i,c&&u.setAttribute(`nonce`,c),document.head.appendChild(u),o)return new Promise((e,t)=>{u.addEventListener(`load`,e),u.addEventListener(`error`,()=>t(Error(`Unable to preload CSS for ${i}`)))})}))}function s(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return o.then(e=>{for(let t of e||[]){if(t.status!==`rejected`)continue;s(t.reason)}return r().catch(s)})},i=e=>e>0?`<span
  ...
  `,u=[{value:`10`,label:`10개`},{value:`20`,label:`20개`},{value:`50`,label:`50개`},{value:`100`,label:`100개`}],ee=e=>`
    <div class="flex items-center gap-2">
  ...
  `,d=({search:e=``,categories:t={},category1:n=``,category2:r=``,isLoading:i=!1,limit:a=`20`,sort:s=`price_asc`})=>` <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-4">
    <!-- 검색창 -->
    ${l(e)}
    <!-- 필터 옵션 -->
    <div class="space-y-3">
  ...
  </div>`,f=e=>{history.pushState(null,``,e),window.dispatchEvent(new PopStateEvent(`popstate`))},p=`cartItems`,m=()=>{try{let e=localStorage.getItem(p);return e?JSON.parse(e):[]}catch(e){return console.error(e),[]}};let h=m(),g=[];function _(){localStorage.setItem(p,JSON.stringify(h)),g.forEach(e=>e(h))}const v={getState:()=>h,setState:e=>{h=[...e],_()},subscribe:e=>(g.push(e),e(h),()=>{g=g.filter(t=>t!==e)})},y={addItem:e=>{let t=v.getState(),n=t.find(t=>t.productId===e.productId),r;r=n?t.map(t=>t.productId===e.productId?{...t,quantity:t.quantity+e.quantity}:t):[...t,{...e}],v.setState(r)},deleteItem:e=>{let t=v.getState(),n=t.filter(t=>t.productId!==e);v.setState(n)},updateQuantity:(e,t)=>{let n=v.getState(),r=n.map(n=>{if(n.productId===e){let e=Math.min(Math.max(1,t),n.stock);return{...n,quantity:e}}return n});v.setState(r)},clearItem:()=>{v.setState([])},subscribe:e=>v.subscribe(e),getState:()=>v.getState()};function b(){let e=y.getState();return e.length}const x=e=>`<div
  ...
  </div>`;document.addEventListener(`click`,e=>{let t=e.target.closest(`.add-to-cart-btn`);if(t){let e=t.closest(`.product-card`);if(!e)return;let n=e.dataset.productId,r=e.querySelector(`img`)?.src,i=e.querySelector(`h3`)?.textContent,a=e.querySelector(`.text-lg.font-bold.text-gray-900`)?.textContent,o={productId:n,title:i,image:r,lprice:a,quantity:1};y.addItem(o);return}let n=e.target.closest(`.product-card`);if(n){let e=n.dataset.productId;f(`/product/${e}`)}});const S=()=>`<div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden animate-pulse">
  ...
  </div>`,C=({products:e=[],isLoading:t=!1,total:n=0,hasNext:r=!1})=>{function i(){return t&&e.length===0?Array.from({length:4}).map(()=>S()).join(``):e.map(e=>x(e)).join(``)}function a(e){return e?`<div class="text-center py-4 text-sm text-gray-500">상품을 불러오는 중...</div>`:`<div class="text-center py-4 text-sm text-gray-500">모든 상품을 확인했습니다</div>`}return` <div class="mb-6">
    <div>
      <!-- 상품 개수 정보 -->
  ...
  `,T=e=>{document.body.querySelector(`#root`).innerHTML=e};function E(e){let t={...e},n=new Set;function r(e){return n.add(e),e(t),()=>n.delete(e)}function i(){return t}function a(e){t={...t,...e},n.forEach(e=>e(t))}return{subscribe:r,getState:i,setState:a}}function D({resetPage:e=!1}={}){let t=new URLSearchParams(location.search);return{page:e?1:parseInt(t.get(`page`)),search:t.get(`search`)||``,sort:t.get(`sort`)||`price_asc`,limit:parseInt(t.get(`limit`))||`20`,category1:t.get(`category1`)||``,category2:t.get(`category2`)||``}}async function O(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`/api/products?${s}`);return await c.json()}async function te(e){let t=await fetch(`/api/products/${e}`);return await t.json()}async function k(){let e=await fetch(`/api/categories`);return await e.json()}function A(e,t){return(e.sort!==t.sort||e.search!==t.search||e.category1!==t.category1||e.category2!==t.category2||e.limit!==t.limit)&&!t.isLoading}function j(e){let t=new URLSearchParams;e.search&&t.set(`search`,e.search),e.sort&&e.sort!==`price_asc`&&t.set(`sort`,e.sort),e.limit&&e.limit!==`20`&&t.set(`limit`,e.limit),e.category1&&t.set(`category1`,e.category1),e.category2&&t.set(`category2`,e.category2),e.page&&e.page!==1&&t.set(`page`,e.page);let n=t.toString(),r=n?`${location.pathname}?${n}`:`${location.pathname}`;history.replaceState(null,``,r)}let M={products:[],categories:{},total:0,isLoading:!1,isCategoryLoading:!1,search:``,category1:``,category2:``,limit:`20`,sort:`price_asc`,page:1,hasNext:!0},N={isLoading:!1,product:{},category1:``,category2:``,relatedProducts:[]};const P=`/front_6th_chapter1-1`,F=(e=window.location.pathname)=>e.startsWith(P)?e.slice(21)||`/`:e;let I=null,L={...M};function R(e,t){T(`
    <div class="bg-gray-50">
      ${a({type:`home`,cartCount:t})}
      <main class="max-w-md mx-auto px-4 py-4">
        ${d({search:e.search,categories:e.categories,category1:e.category1,category2:e.category2,isLoading:e.isCategoryLoading,limit:e.limit,sort:e.sort})}
        ${C({isLoading:e.isLoading,products:e.products,total:e.total,hasNext:e.hasNext})}
      </main>
      ${w()}
    </div>
  `),H()}async function z({isInit:e=!1}={}){let t=e?D({resetPage:e}):I.getState();I.setState({...e?t:{},isLoading:!0,isCategoryLoading:e});try{let[n,r]=await Promise.all([e?k():Promise.resolve(I.getState().categories),O({page:t.page,limit:parseInt(t.limit),search:t.search,category1:t.category1,category2:t.category2,sort:t.sort})]);I.setState({...e?{categories:n}:{},products:r.products,total:r.pagination.total,isLoading:!1,isCategoryLoading:!1})}catch(e){console.error(e),I.setState({isLoading:!1,isCategoryLoading:!1})}}async function B(){let e=I.getState();if(e.loading||!e.hasNext)return;let t=e.products,n=e.page+1;I.setState({isLoading:!0});try{let r=await O({page:n,limit:parseInt(e.limit),search:e.search,category1:e.category1,category2:e.category2,sort:e.sort});I.setState({products:[...t,...r.products],total:r.pagination.total,isLoading:!1,page:n,hasNext:n*parseInt(e.limit)<r.pagination.total}),j(e)}catch(e){console.error(e),I.setState({isLoading:!1})}}function V(e){I||(I=E(M),I.subscribe(t=>{F()===`/`&&R(t,e)}),I.subscribe(e=>{A(L,e)&&(j(e),z()),L={...e}}),z({isInit:!0}).then(()=>{j(I.getState())}))}function H(){let e=I.getState(),t=document.querySelector(`#search-input`);t&&(t.value=e.search,t.onkeypress=e=>{e.key===`Enter`&&I.setState({search:e.target.value,page:1})});let n=document.querySelector(`#limit-select`);n&&(n.onchange=e=>{I.setState({limit:e.target.value,page:1})});let r=document.querySelector(`#sort-select`);r&&(r.onchange=e=>{I.setState({sort:e.target.value,page:1})}),document.querySelectorAll(`[data-category1]:not([data-category2])`).forEach(e=>{e.onclick=e=>{I.setState({category1:e.target.dataset.category1,category2:``,page:1})}}),document.querySelectorAll(`[data-category2]`).forEach(e=>{e.onclick=e=>{I.setState({category1:e.target.dataset.category1,category2:e.target.dataset.category2,page:1})}});let i=document.querySelector(`[data-breadcrumb='reset']`);i&&(i.onclick=()=>{f(`/`),I.setState({category1:``,category2:``,search:``,page:1}),t&&(t.value=``)});let a=document.querySelector(`[data-breadcrumb='category1']`);a&&(a.onclick=e=>{I.setState({category1:e.target.dataset.category1,category2:``,page:1})}),window.addEventListener(`scroll`,()=>{let e=I.getState();e.isLoading||!e.hasNext||window.innerHeight+window.scrollY>=document.body.offsetHeight&&B()}),window.addEventListener(`popstate`,()=>{let e=D();I.setState({...e,page:parseInt(e.page)||1})})}const U=()=>`<svg class="w-4 h-4 text-gray-300" fill="currentColor" viewBox="0 0 20 20">
    <path
  ...
  </div>`;document.addEventListener(`click`,e=>{let t=e.target.closest(`.related-product-card`);if(t){let e=t.dataset.productId;f(`/product/${e}`)}});const K=({products:e=[]})=>`<div class="bg-white rounded-lg shadow-sm">
  ...
  </div>`;function q(e,t){let{isLoading:n,product:r,relatedProducts:i}=e;T(`
  ...
  `),Y(r)}async function J(e,t){N.isLoading=!0,q(N);try{let n=await te(e);N.product=n;let r=await O({category1:n.category1,category2:n.category2,limit:5});N.relatedProducts=r.products.filter(t=>t.productId!==e).slice(0,4)||[],N.isLoading=!1,q(N,t)}catch(e){console.error(e)}}function Y(e){document.querySelector(`.go-to-product-list`)?.addEventListener(`click`,()=>{f(`/`)}),document.querySelectorAll(`.breadcrumb-link`).forEach(e=>{e.addEventListener(`click`,e=>{let t=e.currentTarget,n=t.dataset.category1,r=t.dataset.category2;if(n)f(`/?category1=${encodeURIComponent(n)}`);else if(r){let e=t.closest(`.text-sm`),n=e.querySelector(`[data-category1]`),i=n?.dataset.category1;i&&f(`/?category1=${encodeURIComponent(i)}&category2=${encodeURIComponent(r)}`)}})});let t=document.querySelector(`#quantity-input`),n=parseInt(t?.max)||1;t&&t.addEventListener(`input`,()=>{let e=parseInt(t.value);(e<1||e>n)&&(t.value=1)});let r=document.querySelector(`#quantity-decrease`);r&&r.addEventListener(`click`,()=>{let e=parseInt(t.value)||1;e>1&&(t.value=e-1)});let i=document.querySelector(`#quantity-increase`);i&&i.addEventListener(`click`,()=>{let e=parseInt(t.value)||1;e<n&&(t.value=e+1)});let a=document.querySelector(`#add-to-cart-btn`);a&&a.addEventListener(`click`,()=>{console.log(`dd`);let n=e.productId,r=e.image,i=e.title,a=e.lprice,o={productId:n,title:i,image:r,lprice:a,quantity:parseInt(t.value)};console.log(o),y.addItem(o)})}function X(){let e=`<main class="max-w-md mx-auto px-4 py-4">
    ...
    <div class="bg-gray-50">${a({type:`home`,cartCount:0})} ${e} ${w()}</div>
  ...
  `};function se(){let e=document.querySelector(`header`),t=document.querySelector(`.cart-modal`);e&&!t&&e.insertAdjacentHTML(`afterend`,oe({count:0}));function n(){let e=document.querySelector(`.cart-modal`);e&&e.remove()}let r=document.querySelector(`#cart-modal-close-btn`),i=document.querySelector(`.cart-modal-overlay`);r&&i&&(r.addEventListener(`click`,n),i.addEventListener(`click`,n))}function Q(){document.addEventListener(`click`,e=>{let t=e.target.closest(`#cart-icon-btn`);t&&se()})}const ce=`/front_6th_chapter1-1/`,le=()=>r(async()=>{let{worker:e}=await import(`./browser-C5kS9mQK.js`);return{worker:e}},[]).then(({worker:e})=>e.start({onUnhandledRequest:`bypass`,serviceWorker:{url:`${ce.slice(0,-1)}/mockServiceWorker.js`}}));async function $(){let e=F(),t=b();if(e===`/`)V(t);else if(e.startsWith(`/product/`)){let n=e.split(`/product/`)[1];await J(n,t)}else Z();y.subscribe(e=>{let t=document.querySelector(`#cart-icon-btn`);if(!t)return;let n=t.querySelector(`span`);n&&n.remove(),t.insertAdjacentHTML(`beforeend`,i(e.length))}),Q()}window.addEventListener(`popstate`,$),le().then($);